<!-- Generated by SigMap gen-context.js v7.24.2 — cold context (MCP only) -->
...
### skills/sigmap_mcp_configuration.md
```
h1 ⚡ Handoff Guide: SigMap & Antigravity MCP Server Integration
h2 📋 Prerequisites
h2 🚀 Step-by-Step Setup Guide
h3 Step 1: Initialize SigMap in the Target Codebase
h3 Step 2: Configure Exclusions and Strategies
h3 Step 3: Run the Initial Scan
h2 🛠️ Configuring Antigravity MCP Server
h2 🔍 Verification & Usage
h3 1. Verification of the MCP Server
h3 2. Instructing Antigravity
h2 🔄 Maintenance & Best Practices
h2 🔗 Reference Examples (arra)
code-fence bash
code-fence plain
code-fence json
```
