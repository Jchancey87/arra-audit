...
The following code signatures were extracted by SigMap v7.0.1 on 2026-06-19T15:23:06.895Z.
...
.github/context-cold.md                       +HttpBackendAdapter  +AuditService  ~callOpenAI  ~generateFallbackTemplate
.github/copilot-instructions.md               +App  +ErrorBoundary  +useAutosave  +formatTime
.github/gemini-context.md                     +App  +ErrorBoundary  +useAutosave  +formatTime
```
